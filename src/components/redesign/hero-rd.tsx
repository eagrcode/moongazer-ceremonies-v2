...
//  - Adds an eyebrow line above the H1 ("Independent Celebrant · Lincolnshire")
//  - Splits "MoonGazer" / "Ceremonies" onto two lines with cyan accent on "Ceremonies"
//  - Keeps HareHero image, button row, and overall layout
